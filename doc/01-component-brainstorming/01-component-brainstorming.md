...
- **Drew Ralston**: <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) then delete this comment -->
- **ralston.168**: <!-- TODO: fill with OSU dot number (e.g., buckeye.17) then delete this comment -->
- **2/2 @ 12:40 PM EST**: <!-- TODO: fill with due date and time (e.g., 10/17 @ 3:10 PM EST) then delete this comment -->
...
- Firewall: 
  ...
  - **Additional Considerations** (*note*: "I don't know" is an acceptable
    answer for each of the following questions):
    - Would this component be mutable? Answer and explain:
      - Yes it would because you could add and remove directly from the firewall
    - Would this component rely on any internal classes (e.g., `Map.Pair`)?
      Answer and explain:
    ...
    - Can you implement your secondary methods using your kernel methods?
      ...
      - by using remove to get a Map.Pair and then checking what it's value is to determine if it
      - should be put in the array of allowed ips
