...
/**
 * Interface for the kernel methods of a key management system.
 * Provides core functionality for generating, storing, retrieving, and destroying cryptographic keys.
 */
public interface KeyManagerKernel extends Standard<KeyManager> {
     ...
     *
     * @param keyID
     *            an ID associated with a key to keep track of the specific role of
     *            the key
     * @param access
